...
const sql = fixture.replaceAll("-- @run-preorder-migration", `
...
select lives_ok($catalog_migration$${body}$catalog_migration$, 'catalogue migration completes on populated data');
`);
