...
-- Reruns refresh reviewed copy but deliberately preserve real stock, availability,
-- publication/activation choices, order settings, staff, audit, and commerce facts.
