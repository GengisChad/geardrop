...
/**
 * The card shown when a GEAR//DROP link is shared on WhatsApp, Instagram, Facebook or X.
 * Product pages replace it with their own packshot. Rendered once at build time.
 */

export const alt = "GEAR//DROP · Negozio Beyblade X in Italia";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

/** Chakra Petch, the site's display face, as TTF (the only format the renderer reads). */
async function displayFont(weight: 700, style: "normal" | "italic"): Promise<ArrayBuffer | null> {
  try {
    ...
    // An old user agent makes Google Fonts answer with TrueType instead of WOFF2.
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", flex: 1 }}>
          ...
          <div style={{ display: "flex", marginTop: 30, fontSize: 36, lineHeight: 1.3, color: "#c9c4dc", maxWidth: 620, fontWeight: 700 }}>
            Trottole, starter, lanciatori e stadi. Spedizione in tutta Italia.
          </div>
        </div>
